...
"""
        ...
        for i in range(n_inputs):
            with gr.Box():
                with gr.Column():
                    ...
                    im1 = gr.Image(
                        label="Image", interactive=True, visible=False, type="pil"
                    )
                    strength = gr.Slider(
                        label="Strength",
                        minimum=0,
    ...
    with gr.Row():
        cfg_scale = gr.Slider(
            label="CFG scale", value=3, minimum=1, maximum=10, step=0.5
        )
        n_samples = gr.Slider(
            label="Num samples", value=2, minimum=1, maximum=4, step=1
        )
    ...
    ex = gr.Examples(
        [
            [
                ...
                None,
                None,
                "assets/im-examples/vermeer.jpg",
                "assets/im-examples/matisse.jpg",
                None,
                None,
                None,
                1,
